...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#000000] [background:radial-gradient(125%_125%_at_50%_10%,#000_60%,#FF00B6_100%)]">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                {requiresReset ? (
                  ...
                  <FaPlayCircle className="text-gray-200 h-8 w-8" />
                )}
              </button>
            </div>

            <div className="hidden sm:flex absolute top-[120%] left-0 w-full">
              <div className="flex w-full text-gray-400 p-4 rounded border border-gray-400 bg-gray-400 bg-opacity-10 gap-6">
